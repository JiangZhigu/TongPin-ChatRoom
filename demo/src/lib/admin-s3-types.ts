...
export type AdminEnrollment = { enrollmentId: string; secret: string; uri: string; expiresAt: number };
export type AdminEnrollmentResult = { user: UserView; recoveryCodes: string[] };
