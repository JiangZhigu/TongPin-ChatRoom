...
当前：**M1–M6 已完成本机定向验证、提交与本批审查；M6草稿时序问题在bc4a8586复核关闭。M7消息交互、表情、通知、本人举报、账号注销恢复及保留已完成实现和第8轮真实Chrome验证，历史定位两项界面问题已修复复验，正在冻结与本批审查；随后继续完整SA01–SA14管理后台。V3的P0+P1全范围已获确认，重要权限/保留规则及最终体验工具选择分别等待已发出的回复。** FE-1持续执行，无逐阶段确认点。非常重要的新事项只暂停相关动作，写入[待确认清单](PENDING_CONFIRMATIONS.zh-CN.md)。
...
- M1–M6本地提交保留完整递进历史；M6最终修复/审查提交：bc4a8586c66b79785748ae1ee9435931cc9f2d83。M7当前冻结中；尚未推送。
