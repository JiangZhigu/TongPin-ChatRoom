...
const navigation = [['/admin', '运营概览'], ['/admin/monitoring', '系统监控'], ['/admin/users', '用户管理'], ['/admin/sessions', '会话与连接'], ['/admin/relations', '好友与关系'], ['/admin/groups', '群聊管理'], ['/admin/content', '消息治理'], ['/admin/files', '文件与空间'], ['/admin/reports', '举报工单'], ['/admin/settings', '站点策略']];
