...
export function AccountSettings({ user, onUserChange, onSignedOut, onLogout }: { user: UserView; onUserChange: (user: UserView) => void; onSignedOut: () => void; onLogout?: () => Promise<void> }) {
